...
module.exports = {
    ...
    quenMatKhauBenhNhan: async (req, res) => {
        ...
        try {
            ...
            const mailOptions = {
                from: 'Admin',
                to: email_doimk,
                subject: 'Khôi phục mật khẩu tài khoản Bệnh Nhân',
                text: `Chào bạn, mật khẩu mới của bạn là: ${newPassword}`,
                html: `
                    <p style="color: green;">Chào bạn, mật khẩu mới của bạn là: <strong>${newPassword}</strong></p>
                    <p>Vui lòng đăng nhập lại để tiếp tục sử dụng dịch vụ của chúng tôi.</p>
                `
            };
